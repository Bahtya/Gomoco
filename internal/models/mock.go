...
type MockAPI struct {
	...
	Protocol string `json:"protocol" yaml:"protocol" binding:"required,oneof=http https tcp ftp"`
...
type CreateMockAPIRequest struct {
	...
	Protocol string `json:"protocol" binding:"required,oneof=http https tcp ftp"`
